                           ...
                           <div class="row">
                                    <div class="col-lg-4">
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <a href= "#" data-toggle="modal" data-target="#region1"><image src="assets/img/pinoyplateimage/ginataannalimango2.jpeg" width="100%" height = "30%"></a>
                                            </div>
                                                ...
                                                GINATAANG ALIMANGO
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="panel panel-primary">
                                                                      ...
                                                                      <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region2"> <image src="assets/img/pinoyplateimage/pansitcabagan.jpg" width="100%" height = "30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            PANSIT CABAGAN
                                                                        </div>
                                                             ...
                                                             <div class="col-lg-4">
                                                                    <div class="panel panel-primary">
                                                                        ...
                                                                        <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region3">  <image src="assets/img/pinoyplateimage/pansitbatilpatol.jpg" width="100%" height = "30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            PANSIT BATIL PATOL
                                                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">GINATAANG ALIMANGO</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/ginataannalimango2.jpeg" width="600">

                                            <p align="justify"> Filipino Style Recipe: Crabs in coconut milk or ginataang alimango or alimasag is another simple yet tasty and nutritious seafood dish, basically crabs simmered in coconut milk then season with salt and pepper.</p>
            ...
            <div class="modal fade" id="region2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">PANSIT CABAGAN</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/pansitcabagan.jpg" width="600">

                                            <p align="justify">As the years passed, the recipe of Pancit Cabagan has improved a lot, and has now gained popularity in different parts of Luzon. The new recipe has added garnish such as crunchy “‘lechon carajay’,  and boiled quail eggs.</p>
            ...
            <div class="modal fade" id="region3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">PANSIT BATIL PATOL</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/pansitbatilpatol.jpg" width="600">

                                            <p align="justify">Pancit Batil Patong or Pancit Tuguegarao is made out of pansit miki Tuguegarao, minced carabao meat (water buffalo), bean sprouts and other vegetables topped with egg and chicharon.  Batil Patong if directly translated means “beat the egg” for Batil and “placed on top” for Patong and that explains the egg on top.</p>
