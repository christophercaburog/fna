                           ...
                           <div class="row">
                                    <div class="col-lg-4">
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <a href= "#" data-toggle="modal" data-target="#region1"><image src="assets/img/pinoyplateimage/Butse-Butse.jpg" width="100%" height="30%"></a>
                                            </div>
                                                ...
                                                BUTSE-BUTSE
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="panel panel-primary">
                                                                      ...
                                                                      <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region2"> <image src="assets/img/pinoyplateimage/lechon2.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            LECHON
                                                                        </div>
                                                             ...
                                                             <div class="col-lg-4">
                                                                    <div class="panel panel-primary">
                                                                        ...
                                                                        <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region3">  <image src="assets/img/pinoyplateimage/PineappleCassavaBibingka.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">BUTSE-BUTSE</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/Butse-Butse.jpg" width="600">

                                            <p align="justify">This native dessert is from central visayas region VII. Composed of mashed sweet potato formed into balls and stuffed with grated cassava inside.</p>
            ...
            <div class="modal fade" id="region2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">LECHON</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/lechon2.jpg" width="600">

                                            <p align="justify">Lechón is the Spanish word for suckling pig and in the Philippines, it connotes a whole roasted pig or “ litsong baboy,” in the local language. The process of cooking the lechón involves the whole pig or piglet that has been impaled in a bamboo branch and being slowly roasted over charcoal. The roasted pig is often cooked during national festivities or fiestas, the holiday season, birthdays, weddings, baptisms, family reunions, and other special occasions.</p>
            ...
            <div class="modal fade" id="region3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">PINEAPPLE CASSAVA BIBINGKA</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/PineappleCassavaBibingka.jpg" width="600">

                                            <p align="justify">A unique cassava bibingka for you to try. Makes a good addition if you are selling kakanin. This bibingka is made from the combination of cassava and pineapple fruits as a main ingredients for this special kakanin. </p>
