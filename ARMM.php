                           ...
                           <div class="row">
                                    <div class="col-lg-4">
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <a href= "#" data-toggle="modal" data-target="#region1"><image src="assets/img/pinoyplateimage/guso.jpg" width="100%" height="30%"></a>
                                            </div>
                                               ...
                                               GUSO
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="panel panel-primary">
                                                                      ...
                                                                      <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region2"> <image src="assets/img/pinoyplateimage/SinigangBaka1.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            SINIGANG NA BAKA
                                                                        </div>
                                                             ...
                                                             <div class="col-lg-4">
                                                                    <div class="panel panel-primary">
                                                                        ...
                                                                        <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region3">  <image src="assets/img/pinoyplateimage/panganansisig.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            TINAGTAG
                                                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">GUSO</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/guso.jpg" width="600">

                                            <p align="justify">This particular seaweed or agar agar as others call  it, is very much common in the coastal waters of Visayas and Mindanao. The only difference is that, instead of serving it fresh garnished with onion, tomatoes and vinegar, the Tawi Tawinians blanch the seaweeds then added with little soy sauce and some spices like ginger, onions , giving it a yellowish color.</p>
            ...
            <div class="modal fade" id="region2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">SINIGANG NA BAKA</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/SinigangBaka1.jpg" width="600">

                                            <p align="justify">Sinigang na baka sa sampalok is a tamarind based beef soup. Like the usual sinigang dish, this recipe use tamarind to make the soup sour. This dish taste better for those who don’t like to eat pork since it uses beef. Preparation of the tamarind broth is a not tedious and in fact very simple. And it taste better than commercial sinigang mix in powdered or in liquid form.</p>
            ...
            <div class="modal fade" id="region3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">TINAGTAG</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/panganansisig.jpg" width="600">

                                            <p align="justify">Amik or Tinagtag is a Muslim delicacy that is made from ground rice and sifted through a coconut shell (bao) to hot cooking oil. </p>
