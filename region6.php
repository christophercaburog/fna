                           ...
                           <div class="row">
                                    <div class="col-lg-4">
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <a href= "#" data-toggle="modal" data-target="#region1"><image src="assets/img/pinoyplateimage/chickenbinakol.jpg" width="100%" height="30%"></a>
                                            </div>
                                                ...
                                                CHICKEN BINAKOL
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="panel panel-primary">
                                                                      ...
                                                                      <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region2"> <image src="assets/img/pinoyplateimage/chickeninasal.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            CHICKEN INASAL
                                                                        </div>
                                                             ...
                                                             <div class="col-lg-4">
                                                                    <div class="panel panel-primary">
                                                                        ...
                                                                        <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region3">  <image src="assets/img/pinoyplateimage/pancit-molo.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            PANCIT MOLO
                                                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">CHICKEN BINAKOL</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/chickenbinakol.jpg" width="600">

                                            <p align="justify">Chicken binakol or binakol na manok is another chicken souppopular in Visayas Region specially in Iloilo. This is similar to tinolang manok,instead of regular water we used coconut water and coconut meat. This simple Filipino dish is traditionally cooked inside the bamboo and they used native chicken to give more aroma and taste.</p>
            ...
            <div class="modal fade" id="region2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">CHICKEN INASAL</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/chickeninasal.jpg" width="600">

                                            <p align="justify">The chicken inasal is a popular dish from the City of Bacolod, Philippines. Unlike the usual barbecue or grilled chicken that uses soy sauce, this dish uses different ingredients for its marinade and basting sauce that create a unique flavor. The smoked flavor added by cooking the meat on a hot charcoal grill imbibes the marinade and makes the dish tastier. This dish is also distinct for its yellowish color brought about by the application of achuete or annatto oil.</p>
            ...
            <div class="modal fade" id="region3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">PANCIT MOLO</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/pancit-molo.jpg" width="600">

                                            <p align="justify">Pancit Molo is a filipino recipe that makes you wonder why it was called pansit for term “pancit” or “pansit” means noodles but actually the dish didn’t use any ingredient of noodles in it’s recipe because it uses either wonton, soimai or molo wrappers. Also, most of the pancit recipe are dry while this pancit molo is a soup.</p>
