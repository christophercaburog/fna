                           ...
                           <div class="row">
                                    <div class="col-lg-4">
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <a href= "#" data-toggle="modal" data-target="#region1"><image src="assets/img/pinoyplateimage/Innasin2.jpg" width="100%" height="30%"></a>
                                            </div>
                                                ...
                                                INNASIN
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="panel panel-primary">
                                                                      ...
                                                                      <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region2"> <image src="assets/img/pinoyplateimage/pinikpikan1.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            PINIKPIKAN
                                                                        </div>
                                                             ...
                                                             <div class="col-lg-4">
                                                                    <div class="panel panel-primary">
                                                                        ...
                                                                        <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region3">  <image src="assets/img/pinoyplateimage/safeng2.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            SAFENG
                                                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">INNASIN</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/Innasin2.jpg" width="600">

                                            <p align="justify">The term Innasin is derived from the Bontoc/Igorot term "inassinan" meaning salted. This is used to describe salted pork meat, or meat of the pig. This is actually smoked Ham, but more salty, and in many ways, better. Some Igorots call this "Etag", but according to Ikit ay Ayotsok, the "Etag" could also apply to Beef, Carabao, Deer, Wild Boar meat.</p>
            ...
            <div class="modal fade" id="region2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">PINIKPIKAN</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/pinikpikan1.jpg" width="600">

                                            <p align="justify"> Pinikpikan is a dish from the mountains of the Cordillera region in the Philippines. It is prepared by beating a live chicken with a stick prior to cooking. The beating bruises the chicken's flesh, bringing blood to its surface, which is said to improve the flavour after cooking.</p>
            ...
            <div class="modal fade" id="region3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">SAFENG</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/safeng2.jpg" width="600">

                                            <p align="justify">Safeng or sabeng tastes and smells just like the German Sauerkraut. The main difference lies with the fact that Germans use Cabbages, while Igorots add Sweet Potatoes or Cassava.</p>
