                           ...
                           <div class="row">
                                    <div class="col-lg-4">
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <a href= "#" data-toggle="modal" data-target="#region1"><image src="assets/img/pinoyplateimage/Curacha1.jpg" width="100%" height="30%"></a>
                                            </div>
                                                ...
                                                CURACHA
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="panel panel-primary">
                                                                      ...
                                                                      <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region2"> <image src="assets/img/pinoyplateimage/chicken_pork_adobo.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            CHICKEN PORK ADOBO
                                                                        </div>
                                                             ...
                                                             <div class="col-lg-4">
                                                                    <div class="panel panel-primary">
                                                                        ...
                                                                        <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region3">  <image src="assets/img/pinoyplateimage/kilawin1.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            KILAWIN
                                                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">CURACHA</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/Curacha1.jpg" width="600">

                                            <p align="justify">Curacha also known as spanner crab or red frog crab is a local Chavacano name given to a sea crab species found in Sulu province Zamboanga. It is uniquely found in the deep-waters of Jolo and nowhere else in the world. Curacha abound in waters of Sulu but not Zamboanga. It is known as "Kagang Pamah in Tausug. It is a hybrid crustacean, with crossbreed characteristics of a large sea crab and a big spiny lobster. It is a large crab with a red color, which stays the same in color even when cooked. The crab is usually steamed or boiled so its flavor is preserved. Unlike most crabs whose majority of meat can be found in their claws, the mother-load of the curacha's meat is found in its body. [1] A similar species exists in other countries, know as Ranina ranina.</p>
            ...
            <div class="modal fade" id="region2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">CHICKEN PORK ADOBO</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/chicken_pork_adobo.jpg" width="600">

                                            <p align="justify"> Adobo (Filipino language: "marinade," "sauce" or "seasoning") is the name of a popular dish and cooking process in Philippine cuisine that involves meat, seafood, or vegetables marinated in a sauce of vinegar, soy sauce, and garlic, browned in oil, and simmered in the marinade. It has sometimes been considered as the unofficial national dish of the Philippines.</p>
