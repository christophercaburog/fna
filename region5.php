                           ...
                           <div class="row">
                                    <div class="col-lg-4">
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <a href= "#" data-toggle="modal" data-target="#region1"><image src="assets/img/pinoyplateimage/bicol-express1.jpg" width="100%" height="30%"></a>
                                            </div>
                                                ...
                                                BICOL EXPRESS
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="panel panel-primary">
                                                                      ...
                                                                      <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region2"> <image src="assets/img/pinoyplateimage/laing.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            LAING
                                                                        </div>
                                                             ...
                                                             <div class="col-lg-4">
                                                                    <div class="panel panel-primary">
                                                                        ...
                                                                        <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region3">  <image src="assets/img/pinoyplateimage/pinangat.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            PINANGAT
                                                                        </div>
            ...
            <div class="modal fade" id="region2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">LAING</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/laing.jpg" width="600">

                                            <p align="justify">Laing is equally famous and tasty as the Bicol Express. It is another best dish Bicol (a Region in the philippines) is taking pride of. Its texture is smooth and it milky because of the gata (coconut milk)</p>
            ...
            <div class="modal fade" id="region3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">PINANGAT</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/pinangat.jpg" width="600">

                                            <p align="justify">Pinangat is a Filipino dish that is most commonly prepared with a meat chili and coconut milk, which is then wrapped, or stuffed, in taro leaves. Taro leaves are the defining feature of the dish and may also be referred to as gabi or natong leaves in many restaurants or recipes. The pinangat ingredients that are stuffed into or mixed with the leaves are highly variable and may include ginger, vinegar, onion, or fish. Many variations of pinangat are pinangat na isda, which is pinangat with fish. The fish may be sardines, catfish, tuna, or many others.</p>
