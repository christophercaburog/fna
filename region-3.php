                           ...
                           <div class="row">
                                    <div class="col-lg-4">
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <a href= "#" data-toggle="modal" data-target="#region1"><image src="assets/img/pinoyplateimage/chickengalantina1.jpg" width="100%" height = "30%"></a>
                                            </div>
                                                ...
                                                CHICKEN GALANTINA
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="panel panel-primary">
                                                                      ...
                                                                      <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region2"> <image src="assets/img/pinoyplateimage/porksisig.jpg" width="100%" height = "30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            PORK SISIG
                                                                        </div>
                                                             ...
                                                             <div class="col-lg-4">
                                                                    <div class="panel panel-primary">
                                                                        ...
                                                                        <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region3">  <image src="assets/img/pinoyplateimage/porktocino3.jpg" width="100%" height = "30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            PORK TOCINO
                                                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">CHICKEN GALANTINA</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/chickengalantina1.jpg" width="600">

                                            <p align="justify">Chicken Galantina is a popular Filipino Holiday Stuffed Chicken recipe. This dish is best enjoyed cold and can be eaten with either bread or rice.</p>
            ...
            <div class="modal fade" id="region2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">PORK SISIG</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/porksisig.jpg" width="600">

                                            <p align="justify">Pork Sisig is a popular appetizer that originated from the culinary capital of the Philippines : Pampanga. This delicious dish can also be categorized as a main dish. Pork Sisig was invented by the late Lucia Cunanan. She is popularly know as Aling Lucing – the sisig queen. Originally, pork sisig is composed of chopped pigs face (snout included) and ears with a generous amounts of chicken liver. Hundreds of sisig variations are available today ranging from the original pigs face (maskara) ingredient to a more healthy seafood concoction such as squid,</p>
            ...
            <div class="modal fade" id="region3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">PORK TOCINO</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/porktocino3.jpg" width="600">

                                            <p align="justify">Tocino or tosino is a cured meat product native to the Philippines. It is usually made out of pork and is similar to ham and bacon although beef is also used. It is often reddish in color and has a sweetish taste. Its name is derived from the Spanish word tocino, which is used to describe bacon or cured meat.</p>
