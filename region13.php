                           ...
                           <div class="row">
                                    <div class="col-lg-4">
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <a href= "#" data-toggle="modal" data-target="#region1"><image src="assets/img/pinoyplateimage/AdobongSahang.jpg" width="100%" height="30%"></a>
                                            </div>
                                                ...
                                                ADOBONG SAHANG
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="panel panel-primary">
                                                                      ...
                                                                      <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region2"> <image src="assets/img/pinoyplateimage/sayongsong.jpg" width="100%" height="30%" ></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            SAYONGSONG
                                                                        </div>
                                                             ...
                                                             <div class="col-lg-4">
                                                                    <div class="panel panel-primary">
                                                                        ...
                                                                        <div class="panel-body">
                                                                           <a href= "#" data-toggle="modal" data-target="#region3">  <image src="assets/img/pinoyplateimage/nilambiran.jpg" width="100%" height="30%"></a>
                                                                        </div>
                                                                        <div class="panel-footer">
                                                                            NILAMBIRAN
                                                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">ADOBONG SAHANG</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/AdobongSahang.jpg" width="600">

                                            <p align="justify">Sahang is a sea snail which is abundant in the bodies of water of Surigao. It is then cooked adobo style with bell pepper.</p>
            ...
            <div class="modal fade" id="region2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">SAYONGSONG</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/sayongsong.jpg" width="600">

                                            <p align="justify">This famous Surigao delicacy is a kakanin wrapped in banana leaves with the color and consistency of a puto or rice cake. It’s made up of glutinous rice, brown sugar, calamansi juice, roasted peanut, and coconut milk. Sayongsong comes out wrapped in banana leaves. Some people say it tastes like “puto” but with coconut milk.</p>
            ...
            <div class="modal fade" id="region3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-fire fa-fw">NILAMBIRAN</i></h4>
                                        </div>
                                        <div class="modal-body">
                                          
                                          <image src="assets/img/pinoyplateimage/nilambiran.jpg" width="600">

                                            <p align="justify">Nilambiran is a different version of the suman. It is made of two kinds of glutinous rice, the purplish red and the white, cooked separately with coconut milk, sugar and salt, and delicately intertwined then wrapped in banana leaves. The result is a delightful brown-and-white-striped suman. </p>
