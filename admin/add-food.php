...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','150','height','160','src','flash','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','flash' ); //end AC code
        ...
        <div id="page-wrapper" style="background-image:url(../assets/img/bg/bg_1.png)">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-plus fa-fw"></i> Add Food</h1>
                </div>
                <!--End Page Header -->
            </div>
									 ...
									 <!--	<div class="col-md-4 clearfix"><div id='preview'>
                                       ...
                                       <div class="col-md-4 clearfix"> <div class = "span4"><select name="category" id="application" class="form-control">
										...
										<div class="col-md-4 clearfix"><input type="text" name="niacin" placeholder="niacin"class="form-control" ></div>
										
										<div class="col-md-4 clearfix"><input type="text" name="water" placeholder="water"class="form-control" ></div>
										
										<div class="col-md-4 clearfix"><input type="text" name="ascorbicacid" placeholder="ascorbic acid"class="form-control" ></div>
										
										<div class="col-md-4 clearfix">	<button type="submit" name="enter" class="btn btn-primary">Submit</button>
										</div>
										</div>
                                        </div>
