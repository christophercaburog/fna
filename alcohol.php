...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','150','height','160','src','assets/img/flash','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','assets/img/flash' ); //end AC code
        ...
        <div id="page-wrapper" style="background-image:url(assets/img/bg/bg_1.png)">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-home fa-fw"></i> </h1>
                    <h1 class="page-header">Alcohol</h1>
              </div>
                <!--End Page Header -->
            </div>
...
Health Risks of Alcohol: 12 Health Problems Associated with Chronic  Heavy Drinking</p>
  ...
  &quot;Alcohol  does all kinds of things in the body, and we're not fully aware of all its  effects,&quot; says James C. Garbutt, MD, professor of psychiatry at the  University of North Carolina at Chapel Hill School of Medicine and a researcher  at the university's Bowles Center for Alcohol Studies. &quot;It's a pretty  complicated little molecule.&quot;<br>
                Here  are 12 conditions linked to chronic heavy drinking.</p>
              <h3>Anemia</h3>
              ...
              <h3><a name="3"></a>Cardiovascular disease</h3>
              ...
              <h3>Dementia</h3>
              <p>As  people age, their brains shrink, on average, at a rate of about 1.9% per  decade. That's considered normal. But heavy drinking speeds the shrinkage of  certain key regions in the brain, resulting in memory loss and other symptoms  of dementia.&nbsp;<br>
                ...
                In  addition to the &quot;nonspecific&quot; dementia that stems from brain atrophy,  heavy drinking can cause nutritional deficiencies so severe that they trigger  other forms of dementia.</p>
              <h3>Depression</h3>
              <p>It's  long been known that heavy drinking often goes hand in hand with depression,  but there has been debate about which came first -- the drinking or the  depression. One theory is that depressed people turned to alcohol in an attempt  to &quot;self-medicate&quot; to ease their emotional pain. But a large study  from New Zealand showed that it was probably the other way around -- that is,  heavy drinking led to depression.<br>
                Research  has also shown that depression improves when heavy drinkers go on the wagon,  Saitz says.</p>
              <h3><a name="4"></a>Seizures</h3>
              <p>Heavy  drinking can cause epilepsy and can trigger seizures even in people who don't  have epilepsy. It can also interfere with the action of the medications used to  treat convulsions.</p>
              <h3><a name="5"></a>Gout</h3>
  ...
  <a href="http://www.brown.edu/Student_Services/Health_Services/Health_Education/alcohol,_tobacco,_&_other_drugs/alcohol/alcohol_&_your_body.php#77">back to  top</a> </p>
              ...
              <h3>Links you can use<a name="10"></a></h3>
              <p><a href="http://interwork.sdsu.edu/echug2/index.php?id=UW-Madison" target="_blank"><em>e-CHUG</em></a><br>
                e-CHUG is a free, anonymous assessment tool that provides individualized  feedback on the role alcohol is playing in your life. You can also see how your  use compares with other college students. If you are a Brown student and would  like to talk to someone about your use, you can call Health Education at  401.863-2794 for a confidential appointment or click<a href="http://www.brown.edu/Student_Services/Health_Services/Health_Education/alcohol,_tobacco,_&_other_drugs/resources.php" target="_self">here</a>&nbsp;for  other resources.<br>
  <a href="http://www.dot.wisconsin.gov/safety/motorist/drunkdriving/calculator.htm" target="_blank"><em>The Blood Alcohol Calculator</em></a><br>
                Learn how gender, body weight, food and how fast you drink can affect your  blood alcohol concentration. This is an interactive tool that shows you how  much alcohol is in different drinks and how your BAC would compare to male and  female friends.<br>
                Source :http://www.brown.edu/Student_Services/Health_Services/Health_Education/alcohol,_tobacco,_&amp;_other_drugs/alcohol/alcohol_&amp;_your_body.php</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
